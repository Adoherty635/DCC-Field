...
const punchItemRoutes = require('./routes/punchItems');
const mediaRoutes = require('./routes/media');
const documentRoutes = require('./routes/documents');
const documentMediaRoutes = require('./routes/documentMedia');
...
app.use('/api/projects/:projectId/punch-items', punchItemRoutes);
app.use('/api/media', mediaRoutes);
app.use('/api/projects/:projectId/documents', documentRoutes);
app.use('/api/documents', documentMediaRoutes);
